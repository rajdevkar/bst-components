...
const collapsedSidebar = ref(false); // Variable to store sidebar collapsed status

const toggleSidebar = () => collapsedSidebar.value = !collapsedSidebar.value; // Toggle sidebar collapsed state
</script>
