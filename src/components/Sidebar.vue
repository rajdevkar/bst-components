<template>
  <div class="peer min-h-[calc(100vh-72px)] flex-col space-y-4 overflow-y-scroll bg-neutral-800 border-r border-neutral-350 text-white px-2 py-4"
       :class="{
            'w-64 fixed xl:relative z-50': !collapsedSidebar, // This class is only applied when sidebar is expanded
            'hidden xl:flex': collapsedSidebar // This class is for hiding sidebar in mobile view
        }">
...
import SidebarLinkWDropdown from './SidebarLinkWDropdown.vue';
