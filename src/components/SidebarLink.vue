...
<template>
    <div class="relative">
        <a href="/" class="peer group flex items-center space-x-2 w-full hover:bg-[#171717] active:bg-gold-600 text-white active:text-neutral-750 text-sm font-medium rounded-sm px-4 py-2 transition-all duration-150 ease-in-out">
            <svg width="24px" height="24px">
                <use :xlink:href="iconLink" class="stroke-white group-active:stroke-neutral-750"></use>
            </svg>
